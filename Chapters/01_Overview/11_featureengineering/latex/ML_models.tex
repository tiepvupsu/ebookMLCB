...
\node (fea) [mynode, draw, anchor = west, right =of raw_train.east, minimum width = 3cm, minimum height = 3cm, text width = 2.5cm, fill =gray!20] {Feature Extraction};
...
\node (fea_test) [mynode, draw, anchor = west, right =of raw_test.east, minimum width = 3cm, minimum height = 3cm, text width = 2.5cm, fill =white!15, pattern = none] {Feature Extraction};
