...
\begin{tikzpicture}[shorten >=1pt,draw=black,thick, node distance=\layersep, >= stealth]
    ...
    \begin{scope}
        ...
        \draw [white, fill = gray!35] (\layersep-\pad, -.5*\non) rectangle (\layersep + \pad, .5*\non);
        \foreach \name / \y in {1,...,\non}
        ...
        \draw [white, fill = gray!35] (2*\layersep-\pad, -.5*\ntw) rectangle (2*\layersep + \pad, .5*\ntw);
        \foreach \name / \y in {1,...,\ntw}
        ...
        \draw [gray, fill = white!15] (3*\layersep-\pad, -.5*\nth) rectangle (3*\layersep + \pad, .5*\nth);
        \foreach \name / \y in {1,...,\nth}
        ...
        % \draw [white, fill = orange!15] (-\pad + \layersep, -4 - 2*\pad)
